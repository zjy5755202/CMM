...
public class Compiler/*@bgen(jjtree)*/implements CompilerTreeConstants, CompilerConstants {/*@bgen(jjtree)*/
  protected static JJTCompilerState jjtree = new JJTCompilerState();static SymbolTable table = new SymbolTable();
    static int level = 0;
  public static void main(String args [])
  {
    try {
            InputStream inputstream = new FileInputStream("src\u005c\u005cCompiler\u005c\u005ctest.txt");
...
//循环
  ...
  static final public void ForInitStmt() throws ParseException {
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);String poly1;
  String poly2=null;
  int type=0;
    try {
      poly1 = polynomial();
      if (jj_2_26(3)) {
        ...
        ;
          ...
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
            if(poly2==null) {if (true) return poly1;}
            float f1 = Float.valueOf(poly1);
            float f2 = Float.valueOf(poly2);
            switch(type){
                case 0:  {if (true) return poly1;}
                case 1: if(poly1.equals(poly2)) {if (true) return "1";}  else {if (true) return "0";}
                case 2:if(poly1.equals(poly2)) {if (true) return"0";} else {if (true) return"1";}
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);String term1;
    ...
    try {
      ...
      if (jj_2_29(3)) {
        ...
        ;
          ...
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
            if(term2==null) {if (true) return term1;}
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);String factor1;
  String factor2=null;
  int type=0;
    try {
      factor1 = factor();
      if (jj_2_32(3)) {
        ...
        ;
          ...
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
            if(factor2==null) {if (true) return factor1;}
            ...
            switch(type){
                ...
                case 2:float f0=f1*f2;{if (true) return String.valueOf(f0);}
                default:{if (true) return factor1;}
            }
    } catch (Throwable jjte000) {
          if (jjtc000) {
            jjtree.clearNodeScope(jjtn000);
